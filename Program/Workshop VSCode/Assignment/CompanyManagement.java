 ...
 public class CompanyManagement {  	
             ...
             while ((line = br.readLine()) != null) { 				
                 ...
                 if (ls[1].startsWith("D")) { 					
                     if (ls[5].compareToIgnoreCase("L") == 0) { 						
                         eList.add(new TeamLeader(ls[1], ls[2], Integer.parseInt(ls[7]), ls[3], mp.get(ls[2]),Integer.parseInt(ls[4]), Double.parseDouble(ls[6]))); 
                         }
  
                     else { 						
                         eList.add(new Developer(ls[1], ls[2], Integer.parseInt(ls[5]), ls[3], mp.get(ls[2]),Integer.parseInt(ls[4]))); 
                         }  				
                     } 
     ...
     public ArrayList<Employee> sorted() { 		
         ArrayList<Employee> sortedList = (ArrayList<Employee>) 
         this.empList.clone();  		
