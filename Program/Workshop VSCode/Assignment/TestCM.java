...
public class TestCM {  	
  public static void main(String[] args) {  	
    ...
    sb.append("\n7.Write file"); 		sb.append("\n8.Exit"); 		
    sb.append("\nYour option from 1 - 8 : ");  		
    int choice = 0; 		 		
    CompanyManagement cm = new CompanyManagement(System.getProperty("user.dir") + "/src/input/ListOfEmployees.txt",System.getProperty("user.dir") + "/src/input/PLInfo.txt"); 		
    ...
    while (choice != 8) { 			
      ...
      switch (choice) {  			
          case 1: 				
              empList = cm.getEmployeeFromFile(System.getProperty("user.dir") + "/src/input/ListOfEmployees.txt",System.getProperty("user.dir") + "/src/input/PLInfo.txt"); 				
          ...
          case 7:  				
              ...
              cm.writeFile(System.getProperty("user.dir") + "/src/output/Req2.txt", cm.getDeveloperByProgrammingLanguage("C++"));  				
